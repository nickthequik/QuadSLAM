...
uint8_t camera_registers[] = {
	...
	OV9655_RED,     0x80,
<<<<<<< HEAD
	//OV9655_VREF,    0x02,   // Vertical Frame Control Default = 0x12
	//OV9655_COM1,    0x00,   // Default = 0x00
	OV9655_COM2,    0x03,   // Output drive capability = x4 Default = 0x01
	//OV9655_VER,     0x57,	  // Read Only
	//OV9655_COM3,    0x80,	  // Color Bars Default = 0x00
	//OV9655_COM4,    0x00,	  // Default = 0x00
	//OV9655_COM5,    0x01,	  // Default = 0x01
	OV9655_COM6,    0x46,   // Default = 0x46, WS = 0xC0
	OV9655_AEC,     0x50,   // Default = 0x40
	OV9655_CLKRC,   0x40,   // 0x40 sets to use external clock source
	OV9655_COM7,    0x07,   // 0x70 sets RGB + reserved bit
	OV9655_COM8,    0xEF,   // Default = 0x8F, WS = 0xEF
	OV9655_COM9,    0x3A,   // Default = 0x4A, WS = 0x3A
	//OV9655_COM10,   0x18,   // Default = 0x00
	OV9655_COM10,   0x00,   //
=======
	//OV9655_VREF,    0x02,
	OV9655_VREF,    0x12,
	...
	//OV9655_COM10,   0x18,
	OV9655_COM10,   0x00,
>>>>>>> f6ea64898575a3e3661e08731b79fd01df3454f6
	OV9655_REG16,   0x24,
