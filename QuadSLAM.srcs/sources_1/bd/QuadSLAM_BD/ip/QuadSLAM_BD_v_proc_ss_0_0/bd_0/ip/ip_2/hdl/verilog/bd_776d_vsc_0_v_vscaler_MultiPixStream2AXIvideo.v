...
reg   [0:0] ap_reg_ppstg_exitcond2_i_reg_260_pp0_iter1;
reg   [11:0] j_i_reg_141;
reg    ap_sig_472;
wire   [11:0] grp_v_vscaler_reg_unsigned_short_s_fu_152_ap_return;
reg   [11:0] tmp_i_reg_236;
reg    ap_sig_cseq_ST_st2_fsm_1;
reg    ap_sig_484;
wire    grp_v_vscaler_reg_unsigned_short_s_fu_152_ap_done;
wire    grp_v_vscaler_reg_unsigned_short_s_fu_158_ap_done;
wire   [11:0] grp_v_vscaler_reg_unsigned_short_s_fu_158_ap_return;
reg   [11:0] tmp_i_60_reg_241;
wire   [12:0] tmp_31_i_fu_173_p2;
reg   [12:0] tmp_31_i_reg_246;
wire   [0:0] exitcond1_i_fu_179_p2;
reg    ap_sig_cseq_ST_st3_fsm_2;
reg    ap_sig_504;
reg    ap_sig_519;
wire   [11:0] i_fu_184_p2;
reg   [11:0] i_reg_255;
wire   [0:0] exitcond2_i_fu_194_p2;
reg    ap_sig_529;
wire   [11:0] j_fu_199_p2;
...
wire   [12:0] cols_cast_i_fu_169_p1;
wire   [12:0] j_cast_i_fu_190_p1;
reg   [3:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b1 == ap_continue)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_sig_cseq_ST_st3_fsm_2) & ~(1'b0 == exitcond1_i_fu_179_p2) & ~ap_sig_519)) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_3) & ~(((1'b1 == ap_reg_ppiten_pp0_it1) & (ap_sig_529 | ((1'b0 == exitcond2_i_reg_260) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in)))) | ((1'b1 == ap_reg_ppiten_pp0_it2) & (1'b0 == ap_reg_ppstg_exitcond2_i_reg_260_pp0_iter1) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in))) & ~(1'b0 == exitcond2_i_fu_194_p2))) begin
            ap_reg_ppiten_pp0_it0 <= 1'b0;
        end else if (((1'b1 == ap_sig_cseq_ST_st3_fsm_2) & (1'b0 == exitcond1_i_fu_179_p2) & ~ap_sig_519)) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        end else if ((((1'b1 == ap_sig_cseq_ST_st3_fsm_2) & (1'b0 == exitcond1_i_fu_179_p2) & ~ap_sig_519) | ((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_3) & ~(((1'b1 == ap_reg_ppiten_pp0_it1) & (ap_sig_529 | ((1'b0 == exitcond2_i_reg_260) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in)))) | ((1'b1 == ap_reg_ppiten_pp0_it2) & (1'b0 == ap_reg_ppstg_exitcond2_i_reg_260_pp0_iter1) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in))) & ~(1'b0 == exitcond2_i_fu_194_p2)))) begin
            ap_reg_ppiten_pp0_it1 <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (~(((1'b1 == ap_reg_ppiten_pp0_it1) & (ap_sig_529 | ((1'b0 == exitcond2_i_reg_260) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in)))) | ((1'b1 == ap_reg_ppiten_pp0_it2) & (1'b0 == ap_reg_ppstg_exitcond2_i_reg_260_pp0_iter1) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in)))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_st3_fsm_2) & (1'b0 == exitcond1_i_fu_179_p2) & ~ap_sig_519)) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_3) & (1'b1 == ap_reg_ppiten_pp0_it1) & (1'b0 == exitcond2_i_reg_260) & ~(((1'b1 == ap_reg_ppiten_pp0_it1) & (ap_sig_529 | ((1'b0 == exitcond2_i_reg_260) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in)))) | ((1'b1 == ap_reg_ppiten_pp0_it2) & (1'b0 == ap_reg_ppstg_exitcond2_i_reg_260_pp0_iter1) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in))))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_3) & ~(((1'b1 == ap_reg_ppiten_pp0_it1) & (ap_sig_529 | ((1'b0 == exitcond2_i_reg_260) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in)))) | ((1'b1 == ap_reg_ppiten_pp0_it2) & (1'b0 == ap_reg_ppstg_exitcond2_i_reg_260_pp0_iter1) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in))))) begin
...
always @ (*) begin
    if ((((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_3) & (1'b1 == ap_reg_ppiten_pp0_it1) & (1'b0 == exitcond2_i_reg_260)) | ((1'b1 == ap_reg_ppiten_pp0_it2) & (1'b0 == ap_reg_ppstg_exitcond2_i_reg_260_pp0_iter1)))) begin
...
always @ (*) begin
    if (((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_3) & (1'b1 == ap_reg_ppiten_pp0_it1) & (1'b0 == exitcond2_i_reg_260))) begin
...
always @ (*) begin
    if (((1'b1 == ap_done_reg) | ((1'b1 == ap_sig_cseq_ST_st3_fsm_2) & ~(1'b0 == exitcond1_i_fu_179_p2) & ~ap_sig_519))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_st3_fsm_2 : begin
            if ((~(1'b0 == exitcond1_i_fu_179_p2) & ~ap_sig_519)) begin
                ap_NS_fsm = ap_ST_st1_fsm_0;
            end else if (((1'b0 == exitcond1_i_fu_179_p2) & ~ap_sig_519)) begin
        ...
        ap_ST_pp0_stg0_fsm_3 : begin
            if ((~((1'b1 == ap_reg_ppiten_pp0_it2) & ~(((1'b1 == ap_reg_ppiten_pp0_it1) & (ap_sig_529 | ((1'b0 == exitcond2_i_reg_260) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in)))) | ((1'b1 == ap_reg_ppiten_pp0_it2) & (1'b0 == ap_reg_ppstg_exitcond2_i_reg_260_pp0_iter1) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in))) & ~(1'b1 == ap_reg_ppiten_pp0_it1)) & ~((1'b1 == ap_reg_ppiten_pp0_it0) & ~(((1'b1 == ap_reg_ppiten_pp0_it1) & (ap_sig_529 | ((1'b0 == exitcond2_i_reg_260) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in)))) | ((1'b1 == ap_reg_ppiten_pp0_it2) & (1'b0 == ap_reg_ppstg_exitcond2_i_reg_260_pp0_iter1) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in))) & ~(1'b0 == exitcond2_i_fu_194_p2) & ~(1'b1 == ap_reg_ppiten_pp0_it1)))) begin
                ap_NS_fsm = ap_ST_pp0_stg0_fsm_3;
...
always @ (*) begin
    ap_sig_529 = ((1'b0 == exitcond2_i_reg_260) & (StrmMPix_V_val_V_empty_n == 1'b0));
end
...
assign exitcond1_i_fu_179_p2 = ((i_i_reg_130 == tmp_i_reg_236) ? 1'b1 : 1'b0);

assign exitcond2_i_fu_194_p2 = ((j_i_reg_141 == tmp_i_60_reg_241) ? 1'b1 : 1'b0);
...
assign i_fu_184_p2 = (i_i_reg_130 + ap_const_lv12_1);

assign j_cast_i_fu_190_p1 = j_i_reg_141;

assign j_fu_199_p2 = (j_i_reg_141 + ap_const_lv12_1);

assign tmp_31_i_fu_173_p2 = ($signed(cols_cast_i_fu_169_p1) + $signed(ap_const_lv13_1FFF));
