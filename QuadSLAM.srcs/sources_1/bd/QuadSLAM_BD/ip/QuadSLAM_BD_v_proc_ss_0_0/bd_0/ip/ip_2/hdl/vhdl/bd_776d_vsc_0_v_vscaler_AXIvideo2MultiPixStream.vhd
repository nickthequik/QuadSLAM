...
architecture behav of bd_776d_vsc_0_v_vscaler_AXIvideo2MultiPixStream is 
    ...
    signal exitcond5_i_reg_374 : STD_LOGIC_VECTOR (0 downto 0);
    signal brmerge_i_reg_383 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal eol_2_i_reg_223 : STD_LOGIC_VECTOR (0 downto 0);
    signal img_V_val_V_blk_n : STD_LOGIC;
    signal eol_i_reg_152 : STD_LOGIC_VECTOR (0 downto 0);
    signal j_i_reg_164 : STD_LOGIC_VECTOR (11 downto 0);
    signal eol_reg_175 : STD_LOGIC_VECTOR (0 downto 0);
    signal axi_data_V_1_i_reg_186 : STD_LOGIC_VECTOR (23 downto 0);
    signal axi_last_V_3_i_reg_234 : STD_LOGIC_VECTOR (0 downto 0);
    signal axi_data_V_3_i_reg_246 : STD_LOGIC_VECTOR (23 downto 0);
    signal ap_sig_513 : BOOLEAN;
    signal grp_v_vscaler_reg_unsigned_short_s_fu_258_ap_return : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_i_reg_335 : STD_LOGIC_VECTOR (11 downto 0);
    signal ap_sig_cseq_ST_st2_fsm_1 : STD_LOGIC;
    signal ap_sig_525 : BOOLEAN;
    signal grp_v_vscaler_reg_unsigned_short_s_fu_258_ap_done : STD_LOGIC;
    signal grp_v_vscaler_reg_unsigned_short_s_fu_264_ap_done : STD_LOGIC;
    signal grp_v_vscaler_reg_unsigned_short_s_fu_264_ap_return : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_i_61_reg_340 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_data_V_reg_345 : STD_LOGIC_VECTOR (23 downto 0);
    signal tmp_last_V_reg_353 : STD_LOGIC_VECTOR (0 downto 0);
    signal exitcond4_i_fu_289_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_sig_cseq_ST_st5_fsm_4 : STD_LOGIC;
    signal ap_sig_550 : BOOLEAN;
    signal i_fu_294_p2 : STD_LOGIC_VECTOR (11 downto 0);
    signal i_reg_369 : STD_LOGIC_VECTOR (11 downto 0);
    signal exitcond5_i_fu_300_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_sig_559 : BOOLEAN;
    signal j_fu_305_p2 : STD_LOGIC_VECTOR (11 downto 0);
    signal brmerge_i_fu_314_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_sig_572 : BOOLEAN;
    signal eol_2_i_phi_fu_226_p4 : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_v_vscaler_reg_unsigned_short_s_fu_258_ap_start : STD_LOGIC;
    signal grp_v_vscaler_reg_unsigned_short_s_fu_258_ap_idle : STD_LOGIC;
    signal grp_v_vscaler_reg_unsigned_short_s_fu_258_ap_ready : STD_LOGIC;
    signal grp_v_vscaler_reg_unsigned_short_s_fu_264_ap_start : STD_LOGIC;
    signal grp_v_vscaler_reg_unsigned_short_s_fu_264_ap_idle : STD_LOGIC;
    signal grp_v_vscaler_reg_unsigned_short_s_fu_264_ap_ready : STD_LOGIC;
    signal axi_last_V1_i_reg_121 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_sig_cseq_ST_st10_fsm_7 : STD_LOGIC;
    signal ap_sig_608 : BOOLEAN;
    signal ap_sig_cseq_ST_st4_fsm_3 : STD_LOGIC;
    signal ap_sig_615 : BOOLEAN;
    signal axi_data_V1_i_reg_131 : STD_LOGIC_VECTOR (23 downto 0);
    signal i_i_reg_141 : STD_LOGIC_VECTOR (11 downto 0);
    signal eol_i_phi_fu_156_p4 : STD_LOGIC_VECTOR (0 downto 0);
    signal axi_last_V_2_i_phi_fu_202_p4 : STD_LOGIC_VECTOR (0 downto 0);
    signal p_Val2_s_phi_fu_214_p4 : STD_LOGIC_VECTOR (23 downto 0);
    signal ap_reg_phiprechg_axi_last_V_2_i_reg_197pp1_it1 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_reg_phiprechg_p_Val2_s_reg_210pp1_it1 : STD_LOGIC_VECTOR (23 downto 0);
    signal ap_reg_grp_v_vscaler_reg_unsigned_short_s_fu_258_ap_start : STD_LOGIC := '0';
    signal ap_reg_grp_v_vscaler_reg_unsigned_short_s_fu_264_ap_start : STD_LOGIC := '0';
    signal sof_1_i_fu_80 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    grp_v_vscaler_reg_unsigned_short_s_fu_258 : component bd_776d_vsc_0_v_vscaler_reg_unsigned_short_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_v_vscaler_reg_unsigned_short_s_fu_264 : component bd_776d_vsc_0_v_vscaler_reg_unsigned_short_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_const_logic_1 = ap_continue)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((ap_const_logic_1 = ap_sig_cseq_ST_st5_fsm_4) and not((ap_const_lv1_0 = exitcond4_i_fu_289_p2)))) then 
    ...
    ap_reg_grp_v_vscaler_reg_unsigned_short_s_fu_258_ap_start_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ap_reg_grp_v_vscaler_reg_unsigned_short_s_fu_258_ap_start <= ap_const_logic_0;
            else
                if (((ap_const_logic_1 = ap_sig_cseq_ST_st1_fsm_0) and not(ap_sig_513))) then 
                    ap_reg_grp_v_vscaler_reg_unsigned_short_s_fu_258_ap_start <= ap_const_logic_1;
                elsif ((ap_const_logic_1 = grp_v_vscaler_reg_unsigned_short_s_fu_258_ap_ready)) then 
                    ap_reg_grp_v_vscaler_reg_unsigned_short_s_fu_258_ap_start <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    ap_reg_grp_v_vscaler_reg_unsigned_short_s_fu_264_ap_start_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ap_reg_grp_v_vscaler_reg_unsigned_short_s_fu_264_ap_start <= ap_const_logic_0;
            else
                if (((ap_const_logic_1 = ap_sig_cseq_ST_st1_fsm_0) and not(ap_sig_513))) then 
                    ap_reg_grp_v_vscaler_reg_unsigned_short_s_fu_264_ap_start <= ap_const_logic_1;
                elsif ((ap_const_logic_1 = grp_v_vscaler_reg_unsigned_short_s_fu_264_ap_ready)) then 
                    ap_reg_grp_v_vscaler_reg_unsigned_short_s_fu_264_ap_start <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_logic_1 = ap_sig_cseq_ST_pp1_stg0_fsm_5) and not(((ap_const_logic_1 = ap_reg_ppiten_pp1_it1) and ap_sig_559)) and not((ap_const_lv1_0 = exitcond5_i_fu_300_p2)))) then 
                    ap_reg_ppiten_pp1_it0 <= ap_const_logic_0;
                elsif (((ap_const_logic_1 = ap_sig_cseq_ST_st5_fsm_4) and (ap_const_lv1_0 = exitcond4_i_fu_289_p2))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_logic_1 = ap_sig_cseq_ST_pp2_stg0_fsm_6) and not(((ap_const_logic_1 = ap_reg_ppiten_pp2_it1) and ap_sig_572)) and not((ap_const_lv1_0 = eol_2_i_phi_fu_226_p4)))) then 
                    ap_reg_ppiten_pp2_it0 <= ap_const_logic_0;
                elsif (((ap_const_logic_1 = ap_sig_cseq_ST_pp1_stg0_fsm_5) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1) and not(((ap_const_logic_1 = ap_reg_ppiten_pp1_it1) and ap_sig_559)) and not((ap_const_lv1_0 = exitcond5_i_reg_374)))) then 
    ...
    axi_data_V1_i_reg_131_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
    ...
    axi_data_V_1_i_reg_186_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_pp1_stg0_fsm_5) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1) and (ap_const_lv1_0 = exitcond5_i_reg_374) and not(((ap_const_logic_1 = ap_reg_ppiten_pp1_it1) and ap_sig_559)))) then 
    ...
    axi_data_V_3_i_reg_246_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_pp1_stg0_fsm_5) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1) and not(((ap_const_logic_1 = ap_reg_ppiten_pp1_it1) and ap_sig_559)) and not((ap_const_lv1_0 = exitcond5_i_reg_374)))) then 
                axi_data_V_3_i_reg_246 <= axi_data_V_1_i_reg_186;
            elsif (((ap_const_logic_1 = ap_sig_cseq_ST_pp2_stg0_fsm_6) and (ap_const_logic_1 = ap_reg_ppiten_pp2_it1) and (ap_const_lv1_0 = eol_2_i_reg_223) and not(((ap_const_logic_1 = ap_reg_ppiten_pp2_it1) and ap_sig_572)))) then 
                axi_data_V_3_i_reg_246 <= AXI_video_strm_V_data_V_0_data_out;
            end if; 
        end if;
    end process;

    axi_last_V1_i_reg_121_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_sig_cseq_ST_st4_fsm_3)) then 
    ...
    axi_last_V_3_i_reg_234_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_pp1_stg0_fsm_5) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1) and not(((ap_const_logic_1 = ap_reg_ppiten_pp1_it1) and ap_sig_559)) and not((ap_const_lv1_0 = exitcond5_i_reg_374)))) then 
    ...
    eol_2_i_reg_223_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_pp1_stg0_fsm_5) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1) and not(((ap_const_logic_1 = ap_reg_ppiten_pp1_it1) and ap_sig_559)) and not((ap_const_lv1_0 = exitcond5_i_reg_374)))) then 
    ...
    eol_i_reg_152_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_pp1_stg0_fsm_5) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1) and (ap_const_lv1_0 = exitcond5_i_reg_374) and not(((ap_const_logic_1 = ap_reg_ppiten_pp1_it1) and ap_sig_559)))) then 
                eol_i_reg_152 <= axi_last_V_2_i_phi_fu_202_p4;
            elsif (((ap_const_logic_1 = ap_sig_cseq_ST_st5_fsm_4) and (ap_const_lv1_0 = exitcond4_i_fu_289_p2))) then 
                eol_i_reg_152 <= ap_const_lv1_0;
            end if; 
        end if;
    end process;
    ...
    i_i_reg_141_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_sig_cseq_ST_st4_fsm_3)) then 
    ...
    j_i_reg_164_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_pp1_stg0_fsm_5) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it0) and not(((ap_const_logic_1 = ap_reg_ppiten_pp1_it1) and ap_sig_559)) and (ap_const_lv1_0 = exitcond5_i_fu_300_p2))) then 
    ...
    sof_1_i_fu_80_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_pp1_stg0_fsm_5) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it0) and not(((ap_const_logic_1 = ap_reg_ppiten_pp1_it1) and ap_sig_559)) and (ap_const_lv1_0 = exitcond5_i_fu_300_p2))) then 
                sof_1_i_fu_80 <= ap_const_lv1_0;
            elsif ((ap_const_logic_1 = ap_sig_cseq_ST_st4_fsm_3)) then 
                sof_1_i_fu_80 <= ap_const_lv1_1;
            end if; 
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_pp1_stg0_fsm_5) and not(((ap_const_logic_1 = ap_reg_ppiten_pp1_it1) and ap_sig_559)) and (ap_const_lv1_0 = exitcond5_i_fu_300_p2))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1) and not(((ap_const_logic_0 = grp_v_vscaler_reg_unsigned_short_s_fu_258_ap_done) or (ap_const_logic_0 = grp_v_vscaler_reg_unsigned_short_s_fu_264_ap_done))))) then
    ...
    ap_NS_fsm_assign_proc : process (ap_CS_fsm, AXI_video_strm_V_data_V_0_vld_out, ap_sig_cseq_ST_pp1_stg0_fsm_5, ap_reg_ppiten_pp1_it1, ap_reg_ppiten_pp1_it0, ap_sig_cseq_ST_pp2_stg0_fsm_6, ap_reg_ppiten_pp2_it1, ap_reg_ppiten_pp2_it0, ap_sig_513, grp_v_vscaler_reg_unsigned_short_s_fu_258_ap_done, grp_v_vscaler_reg_unsigned_short_s_fu_264_ap_done, exitcond4_i_fu_289_p2, ap_sig_559, ap_sig_572, tmp_user_V_fu_280_p1)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_st2_fsm_1 => 
                if (not(((ap_const_logic_0 = grp_v_vscaler_reg_unsigned_short_s_fu_258_ap_done) or (ap_const_logic_0 = grp_v_vscaler_reg_unsigned_short_s_fu_264_ap_done)))) then
                    ap_NS_fsm <= ap_ST_st3_fsm_2;
                else
                    ap_NS_fsm <= ap_ST_st2_fsm_1;
                end if;
            when ap_ST_st3_fsm_2 => 
                if ((not((AXI_video_strm_V_data_V_0_vld_out = ap_const_logic_0)) and (ap_const_lv1_0 = tmp_user_V_fu_280_p1))) then
                    ap_NS_fsm <= ap_ST_st3_fsm_2;
                elsif ((not((AXI_video_strm_V_data_V_0_vld_out = ap_const_logic_0)) and not((ap_const_lv1_0 = tmp_user_V_fu_280_p1)))) then
            ...
            when ap_ST_st5_fsm_4 => 
                if (not((ap_const_lv1_0 = exitcond4_i_fu_289_p2))) then
                    ap_NS_fsm <= ap_ST_st1_fsm_0;
                else
    ...
    AXI_video_strm_TDATA_blk_n_assign_proc : process(AXI_video_strm_V_data_V_0_state, ap_sig_cseq_ST_st3_fsm_2, ap_sig_cseq_ST_pp1_stg0_fsm_5, ap_reg_ppiten_pp1_it1, exitcond5_i_reg_374, brmerge_i_reg_383, ap_sig_cseq_ST_pp2_stg0_fsm_6, ap_reg_ppiten_pp2_it1, eol_2_i_reg_223)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_st3_fsm_2) or ((ap_const_logic_1 = ap_sig_cseq_ST_pp1_stg0_fsm_5) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1) and (ap_const_lv1_0 = exitcond5_i_reg_374) and (ap_const_lv1_0 = brmerge_i_reg_383)) or ((ap_const_logic_1 = ap_sig_cseq_ST_pp2_stg0_fsm_6) and (ap_const_logic_1 = ap_reg_ppiten_pp2_it1) and (ap_const_lv1_0 = eol_2_i_reg_223)))) then 
    ...
    AXI_video_strm_V_data_V_0_ack_out_assign_proc : process(AXI_video_strm_V_data_V_0_vld_out, ap_sig_cseq_ST_st3_fsm_2, ap_sig_cseq_ST_pp1_stg0_fsm_5, ap_reg_ppiten_pp1_it1, exitcond5_i_reg_374, brmerge_i_reg_383, ap_sig_cseq_ST_pp2_stg0_fsm_6, ap_reg_ppiten_pp2_it1, eol_2_i_reg_223, ap_sig_559, ap_sig_572)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_st3_fsm_2) and not((AXI_video_strm_V_data_V_0_vld_out = ap_const_logic_0))) or ((ap_const_logic_1 = ap_sig_cseq_ST_pp2_stg0_fsm_6) and (ap_const_logic_1 = ap_reg_ppiten_pp2_it1) and (ap_const_lv1_0 = eol_2_i_reg_223) and not(((ap_const_logic_1 = ap_reg_ppiten_pp2_it1) and ap_sig_572))) or ((ap_const_logic_1 = ap_sig_cseq_ST_pp1_stg0_fsm_5) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1) and (ap_const_lv1_0 = exitcond5_i_reg_374) and (ap_const_lv1_0 = brmerge_i_reg_383) and not(((ap_const_logic_1 = ap_reg_ppiten_pp1_it1) and ap_sig_559))))) then 
    ...
    AXI_video_strm_V_dest_V_0_ack_out_assign_proc : process(AXI_video_strm_V_data_V_0_vld_out, ap_sig_cseq_ST_st3_fsm_2, ap_sig_cseq_ST_pp1_stg0_fsm_5, ap_reg_ppiten_pp1_it1, exitcond5_i_reg_374, brmerge_i_reg_383, ap_sig_cseq_ST_pp2_stg0_fsm_6, ap_reg_ppiten_pp2_it1, eol_2_i_reg_223, ap_sig_559, ap_sig_572)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_st3_fsm_2) and not((AXI_video_strm_V_data_V_0_vld_out = ap_const_logic_0))) or ((ap_const_logic_1 = ap_sig_cseq_ST_pp2_stg0_fsm_6) and (ap_const_logic_1 = ap_reg_ppiten_pp2_it1) and (ap_const_lv1_0 = eol_2_i_reg_223) and not(((ap_const_logic_1 = ap_reg_ppiten_pp2_it1) and ap_sig_572))) or ((ap_const_logic_1 = ap_sig_cseq_ST_pp1_stg0_fsm_5) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1) and (ap_const_lv1_0 = exitcond5_i_reg_374) and (ap_const_lv1_0 = brmerge_i_reg_383) and not(((ap_const_logic_1 = ap_reg_ppiten_pp1_it1) and ap_sig_559))))) then 
    ...
    AXI_video_strm_V_last_V_0_ack_out_assign_proc : process(AXI_video_strm_V_data_V_0_vld_out, ap_sig_cseq_ST_st3_fsm_2, ap_sig_cseq_ST_pp1_stg0_fsm_5, ap_reg_ppiten_pp1_it1, exitcond5_i_reg_374, brmerge_i_reg_383, ap_sig_cseq_ST_pp2_stg0_fsm_6, ap_reg_ppiten_pp2_it1, eol_2_i_reg_223, ap_sig_559, ap_sig_572)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_st3_fsm_2) and not((AXI_video_strm_V_data_V_0_vld_out = ap_const_logic_0))) or ((ap_const_logic_1 = ap_sig_cseq_ST_pp2_stg0_fsm_6) and (ap_const_logic_1 = ap_reg_ppiten_pp2_it1) and (ap_const_lv1_0 = eol_2_i_reg_223) and not(((ap_const_logic_1 = ap_reg_ppiten_pp2_it1) and ap_sig_572))) or ((ap_const_logic_1 = ap_sig_cseq_ST_pp1_stg0_fsm_5) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1) and (ap_const_lv1_0 = exitcond5_i_reg_374) and (ap_const_lv1_0 = brmerge_i_reg_383) and not(((ap_const_logic_1 = ap_reg_ppiten_pp1_it1) and ap_sig_559))))) then 
    ...
    AXI_video_strm_V_user_V_0_ack_out_assign_proc : process(AXI_video_strm_V_data_V_0_vld_out, ap_sig_cseq_ST_st3_fsm_2, ap_sig_cseq_ST_pp1_stg0_fsm_5, ap_reg_ppiten_pp1_it1, exitcond5_i_reg_374, brmerge_i_reg_383, ap_sig_cseq_ST_pp2_stg0_fsm_6, ap_reg_ppiten_pp2_it1, eol_2_i_reg_223, ap_sig_559, ap_sig_572)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_st3_fsm_2) and not((AXI_video_strm_V_data_V_0_vld_out = ap_const_logic_0))) or ((ap_const_logic_1 = ap_sig_cseq_ST_pp2_stg0_fsm_6) and (ap_const_logic_1 = ap_reg_ppiten_pp2_it1) and (ap_const_lv1_0 = eol_2_i_reg_223) and not(((ap_const_logic_1 = ap_reg_ppiten_pp2_it1) and ap_sig_572))) or ((ap_const_logic_1 = ap_sig_cseq_ST_pp1_stg0_fsm_5) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1) and (ap_const_lv1_0 = exitcond5_i_reg_374) and (ap_const_lv1_0 = brmerge_i_reg_383) and not(((ap_const_logic_1 = ap_reg_ppiten_pp1_it1) and ap_sig_559))))) then 
    ...
    ap_done_assign_proc : process(ap_done_reg, exitcond4_i_fu_289_p2, ap_sig_cseq_ST_st5_fsm_4)
    begin
        if (((ap_const_logic_1 = ap_done_reg) or ((ap_const_logic_1 = ap_sig_cseq_ST_st5_fsm_4) and not((ap_const_lv1_0 = exitcond4_i_fu_289_p2))))) then 
    ...
    ap_ready_assign_proc : process(exitcond4_i_fu_289_p2, ap_sig_cseq_ST_st5_fsm_4)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_st5_fsm_4) and not((ap_const_lv1_0 = exitcond4_i_fu_289_p2)))) then 
    ...
    ap_reg_phiprechg_axi_last_V_2_i_reg_197pp1_it1 <= "X";
    ap_reg_phiprechg_p_Val2_s_reg_210pp1_it1 <= "XXXXXXXXXXXXXXXXXXXXXXXX";
    ...
    ap_sig_491_assign_proc : process(ap_sig_cseq_ST_pp1_stg0_fsm_5, ap_reg_ppiten_pp1_it1, exitcond5_i_reg_374)
    begin
                ap_sig_491 <= ((ap_const_logic_1 = ap_sig_cseq_ST_pp1_stg0_fsm_5) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1) and (ap_const_lv1_0 = exitcond5_i_reg_374));
    end process;
    ...
    ap_sig_559_assign_proc : process(AXI_video_strm_V_data_V_0_vld_out, img_V_val_V_full_n, exitcond5_i_reg_374, brmerge_i_reg_383)
    begin
                ap_sig_559 <= (((ap_const_lv1_0 = exitcond5_i_reg_374) and (ap_const_lv1_0 = brmerge_i_reg_383) and (AXI_video_strm_V_data_V_0_vld_out = ap_const_logic_0)) or ((ap_const_lv1_0 = exitcond5_i_reg_374) and (img_V_val_V_full_n = ap_const_logic_0)));
    end process;


    ap_sig_572_assign_proc : process(AXI_video_strm_V_data_V_0_vld_out, eol_2_i_reg_223)
    begin
                ap_sig_572 <= ((ap_const_lv1_0 = eol_2_i_reg_223) and (AXI_video_strm_V_data_V_0_vld_out = ap_const_logic_0));
    end process;
    ...
    axi_last_V_2_i_phi_fu_202_p4_assign_proc : process(AXI_video_strm_V_last_V_0_data_out, brmerge_i_reg_383, eol_reg_175, ap_reg_phiprechg_axi_last_V_2_i_reg_197pp1_it1, ap_sig_491)
    begin
        if (ap_sig_491) then
            if (not((ap_const_lv1_0 = brmerge_i_reg_383))) then 
                axi_last_V_2_i_phi_fu_202_p4 <= eol_reg_175;
            elsif ((ap_const_lv1_0 = brmerge_i_reg_383)) then 
    ...
    brmerge_i_fu_314_p2 <= (sof_1_i_fu_80 or eol_i_phi_fu_156_p4);

    eol_2_i_phi_fu_226_p4_assign_proc : process(AXI_video_strm_V_last_V_0_data_out, ap_sig_cseq_ST_pp2_stg0_fsm_6, ap_reg_ppiten_pp2_it1, eol_2_i_reg_223)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_pp2_stg0_fsm_6) and (ap_const_logic_1 = ap_reg_ppiten_pp2_it1) and (ap_const_lv1_0 = eol_2_i_reg_223))) then 
    ...
    eol_i_phi_fu_156_p4_assign_proc : process(ap_sig_cseq_ST_pp1_stg0_fsm_5, ap_reg_ppiten_pp1_it1, exitcond5_i_reg_374, eol_i_reg_152, axi_last_V_2_i_phi_fu_202_p4)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_pp1_stg0_fsm_5) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1) and (ap_const_lv1_0 = exitcond5_i_reg_374))) then 
    ...
    exitcond4_i_fu_289_p2 <= "1" when (i_i_reg_141 = tmp_i_reg_335) else "0";
    exitcond5_i_fu_300_p2 <= "1" when (j_i_reg_164 = tmp_i_61_reg_340) else "0";
    grp_v_vscaler_reg_unsigned_short_s_fu_258_ap_start <= ap_reg_grp_v_vscaler_reg_unsigned_short_s_fu_258_ap_start;
    grp_v_vscaler_reg_unsigned_short_s_fu_264_ap_start <= ap_reg_grp_v_vscaler_reg_unsigned_short_s_fu_264_ap_start;
    i_fu_294_p2 <= std_logic_vector(unsigned(i_i_reg_141) + unsigned(ap_const_lv12_1));

    img_V_val_V_blk_n_assign_proc : process(img_V_val_V_full_n, ap_sig_cseq_ST_pp1_stg0_fsm_5, ap_reg_ppiten_pp1_it1, exitcond5_i_reg_374)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_pp1_stg0_fsm_5) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1) and (ap_const_lv1_0 = exitcond5_i_reg_374))) then 
    ...
    img_V_val_V_din <= p_Val2_s_phi_fu_214_p4;

    img_V_val_V_write_assign_proc : process(ap_sig_cseq_ST_pp1_stg0_fsm_5, ap_reg_ppiten_pp1_it1, exitcond5_i_reg_374, ap_sig_559)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_pp1_stg0_fsm_5) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1) and (ap_const_lv1_0 = exitcond5_i_reg_374) and not(((ap_const_logic_1 = ap_reg_ppiten_pp1_it1) and ap_sig_559)))) then 
    ...
    j_fu_305_p2 <= std_logic_vector(unsigned(j_i_reg_164) + unsigned(ap_const_lv12_1));

    p_Val2_s_phi_fu_214_p4_assign_proc : process(AXI_video_strm_V_data_V_0_data_out, brmerge_i_reg_383, axi_data_V_1_i_reg_186, ap_reg_phiprechg_p_Val2_s_reg_210pp1_it1, ap_sig_491)
    begin
        if (ap_sig_491) then
            if (not((ap_const_lv1_0 = brmerge_i_reg_383))) then 
    ...
    tmp_user_V_fu_280_p1 <= AXI_video_strm_V_user_V_0_data_out;
end behav;
