...
module bd_776d_hsc_0_v_hscaler_AXIvideo2MultiPixStream69 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [11:0] i_cast_i_i_fu_360_p1;
wire   [11:0] j_cast_i_i_fu_375_p1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b1 == ap_continue)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_sig_cseq_ST_st4_fsm_3) & ~(1'b0 == exitcond8_i_i_fu_364_p2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & ~((1'b1 == ap_reg_ppiten_pp1_it1) & ap_sig_586) & ~(1'b0 == exitcond9_i_i_fu_379_p2))) begin
            ap_reg_ppiten_pp1_it0 <= 1'b0;
        end else if (((1'b1 == ap_sig_cseq_ST_st4_fsm_3) & (1'b0 == exitcond8_i_i_fu_364_p2))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_sig_cseq_ST_pp2_stg0_fsm_5) & ~((1'b1 == ap_reg_ppiten_pp2_it1) & ap_sig_599) & ~(1'b0 == eol_2_i_i_phi_fu_297_p4))) begin
            ap_reg_ppiten_pp2_it0 <= 1'b0;
        end else if (((1'b1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & (1'b1 == ap_reg_ppiten_pp1_it1) & ~((1'b1 == ap_reg_ppiten_pp1_it1) & ap_sig_586) & ~(1'b0 == exitcond9_i_i_reg_516))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & (1'b1 == ap_reg_ppiten_pp1_it1) & (1'b0 == exitcond9_i_i_reg_516) & ~((1'b1 == ap_reg_ppiten_pp1_it1) & ap_sig_586))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & (1'b1 == ap_reg_ppiten_pp1_it1) & ~((1'b1 == ap_reg_ppiten_pp1_it1) & ap_sig_586) & ~(1'b0 == exitcond9_i_i_reg_516))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & (1'b1 == ap_reg_ppiten_pp1_it0) & ~((1'b1 == ap_reg_ppiten_pp1_it1) & ap_sig_586) & (1'b0 == exitcond9_i_i_fu_379_p2))) begin
...
always @ (*) begin
    if (((1'b1 == ap_done_reg) | ((1'b1 == ap_sig_cseq_ST_st4_fsm_3) & ~(1'b0 == exitcond8_i_i_fu_364_p2)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_sig_cseq_ST_st4_fsm_3) & ~(1'b0 == exitcond8_i_i_fu_364_p2))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & (1'b1 == ap_reg_ppiten_pp1_it1) & (1'b0 == exitcond9_i_i_reg_516))) begin
...
always @ (*) begin
    if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) | ((1'b1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & (1'b1 == ap_reg_ppiten_pp1_it1) & (1'b0 == exitcond9_i_i_reg_516) & (1'b0 == brmerge_i_i_reg_525)) | ((1'b1 == ap_sig_cseq_ST_pp2_stg0_fsm_5) & (1'b1 == ap_reg_ppiten_pp2_it1) & (1'b0 == eol_2_i_i_reg_294)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_st4_fsm_3 : begin
            if (~(1'b0 == exitcond8_i_i_fu_364_p2)) begin
                ap_NS_fsm = ap_ST_st1_fsm_0;
            end else begin
...
always @ (*) begin
    ap_sig_508 = ((1'b1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & (1'b1 == ap_reg_ppiten_pp1_it1) & (1'b0 == exitcond9_i_i_reg_516));
end
...
always @ (*) begin
    ap_sig_586 = (((1'b0 == exitcond9_i_i_reg_516) & (1'b0 == brmerge_i_i_reg_525) & (AXI_video_strm_V_data_V_0_vld_out == 1'b0)) | ((1'b0 == exitcond9_i_i_reg_516) & (img_V_val_V_full_n == 1'b0)));
end
...
assign exitcond8_i_i_fu_364_p2 = ((i_cast_i_i_fu_360_p1 == tmp_31_reg_495) ? 1'b1 : 1'b0);

assign exitcond9_i_i_fu_379_p2 = ((j_cast_i_i_fu_375_p1 == tmp_reg_470) ? 1'b1 : 1'b0);

assign i_cast_i_i_fu_360_p1 = i_i_i_reg_213;

assign i_fu_369_p2 = (i_i_i_reg_213 + ap_const_lv11_1);
...
assign j_fu_384_p2 = (j_i_i_reg_236 + ap_const_lv11_1);
...
assign tmp_31_fu_347_p1 = Height[11:0];

assign tmp_fu_339_p1 = WidthIn[11:0];

assign tmp_user_V_fu_343_p1 = AXI_video_strm_V_user_V_0_data_out;

endmodule //bd_776d_hsc_0_v_hscaler_AXIvideo2MultiPixStream69
