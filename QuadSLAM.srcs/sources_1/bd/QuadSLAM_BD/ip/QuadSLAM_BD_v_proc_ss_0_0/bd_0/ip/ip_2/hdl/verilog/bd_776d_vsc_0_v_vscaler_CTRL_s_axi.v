...
`timescale 1ns/1ps
module bd_776d_vsc_0_v_vscaler_CTRL_s_axi
#(parameter
...
localparam
    ...
    ADDR_IER                    = 6'h08,
    ADDR_ISR                    = 6'h0c,
    ADDR_HWREG_HEIGHTIN_DATA_0  = 6'h10,
    ADDR_HWREG_HEIGHTIN_CTRL    = 6'h14,
    ADDR_HWREG_WIDTH_DATA_0     = 6'h18,
    ADDR_HWREG_WIDTH_CTRL       = 6'h1c,
    ADDR_HWREG_HEIGHTOUT_DATA_0 = 6'h20,
    ADDR_HWREG_HEIGHTOUT_CTRL   = 6'h24,
    ADDR_HWREG_LINERATE_DATA_0  = 6'h28,
    ADDR_HWREG_LINERATE_CTRL    = 6'h2c,
    WRIDLE                      = 2'd0,
    WRDATA                      = 2'd1,
    WRRESP                      = 2'd2,
    RDIDLE                      = 2'd0,
...
//------------------------Local signal-------------------
    ...
    reg  [1:0]                    int_ier;
    reg  [1:0]                    int_isr;
    reg  [15:0]                   int_HwReg_HeightIn;
    reg  [15:0]                   int_HwReg_Width;
    reg  [15:0]                   int_HwReg_HeightOut;
    reg  [31:0]                   int_HwReg_LineRate;
