...
reg   [0:0] exitcond6_i_reg_587;
reg    AXI_video_strm_TDATA_blk_n;
reg   [0:0] ap_reg_ppstg_exitcond6_i_reg_587_pp0_iter1;
reg    Height_blk_n;
reg    WidthOut_blk_n;
reg    ColorMode_blk_n;
reg   [10:0] j_i_reg_238;
reg   [15:0] Height_read_reg_498;
reg    ap_sig_502;
wire   [10:0] tmp_22_fu_249_p1;
reg   [10:0] tmp_22_reg_503;
wire   [11:0] tmp_23_fu_253_p1;
reg   [11:0] tmp_23_reg_508;
...
wire   [11:0] tmp_26_fu_305_p1;
reg   [11:0] tmp_26_reg_538;
wire   [10:0] tmp_21_i_fu_308_p2;
reg   [10:0] tmp_21_i_reg_543;
wire   [1:0] tmp_27_fu_313_p1;
reg   [1:0] tmp_27_reg_548;
wire   [1:0] tmp_28_fu_317_p1;
reg   [1:0] tmp_28_reg_553;
wire   [1:0] tmp_29_fu_321_p1;
reg   [1:0] tmp_29_reg_558;
wire   [3:0] map_2_V_1_fu_354_p3;
reg    ap_sig_cseq_ST_st3_fsm_2;
reg    ap_sig_544;
wire   [3:0] map_2_V_3_fu_370_p3;
wire   [3:0] map_2_V_5_fu_378_p3;
wire   [0:0] exitcond5_i_fu_390_p2;
reg    ap_sig_cseq_ST_st4_fsm_3;
reg    ap_sig_557;
reg    ap_sig_572;
wire   [10:0] i_1_fu_395_p2;
reg   [10:0] i_1_reg_582;
wire   [0:0] exitcond6_i_fu_405_p2;
reg    ap_sig_582;
wire   [10:0] j_fu_410_p2;
...
reg   [1:0] i_i_reg_215;
reg   [10:0] i1_i_reg_227;
wire  signed [63:0] tmp_9_cast_fu_300_p1;
reg   [0:0] tmp_user_V_fu_110;
wire   [2:0] tmp_25_fu_261_p1;
wire   [4:0] p_shl_cast_fu_265_p3;
wire   [4:0] tmp_24_fu_257_p1;
wire   [4:0] tmp_22_i_cast_fu_291_p1;
...
wire   [11:0] i1_cast_i_fu_386_p1;
wire   [11:0] j_cast_i_fu_401_p1;
...
wire   [7:0] tmp_1_fu_471_p2;
wire   [7:0] tmp_1_fu_471_p3;
wire   [7:0] tmp_1_fu_471_p5;
...
bd_776d_hsc_0_v_hscaler_mux_3to1_sel2_8_1 #(
    ...
    .din4_WIDTH( 2 ),
    .dout_WIDTH( 8 ))
v_hscaler_mux_3to1_sel2_8_1_U80(
...
bd_776d_hsc_0_v_hscaler_mux_3to1_sel2_8_1 #(
    ...
    .din4_WIDTH( 2 ),
    .dout_WIDTH( 8 ))
v_hscaler_mux_3to1_sel2_8_1_U81(
    .din1(pix_val_0_V_fu_425_p1),
...
bd_776d_hsc_0_v_hscaler_mux_3to1_sel2_8_1 #(
    ...
    .din4_WIDTH( 2 ),
    .dout_WIDTH( 8 ))
v_hscaler_mux_3to1_sel2_8_1_U82(
    .din1(pix_val_0_V_fu_425_p1),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b1 == ap_continue)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_sig_cseq_ST_st4_fsm_3) & ~(1'b0 == exitcond5_i_fu_390_p2) & ~ap_sig_572)) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_4) & ~(((1'b1 == ap_reg_ppiten_pp0_it1) & (ap_sig_582 | ((1'b0 == exitcond6_i_reg_587) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in)))) | ((1'b1 == ap_reg_ppiten_pp0_it2) & (1'b0 == ap_reg_ppstg_exitcond6_i_reg_587_pp0_iter1) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in))) & ~(1'b0 == exitcond6_i_fu_405_p2))) begin
            ap_reg_ppiten_pp0_it0 <= 1'b0;
        end else if (((1'b1 == ap_sig_cseq_ST_st4_fsm_3) & (1'b0 == exitcond5_i_fu_390_p2) & ~ap_sig_572)) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        end else if ((((1'b1 == ap_sig_cseq_ST_st4_fsm_3) & (1'b0 == exitcond5_i_fu_390_p2) & ~ap_sig_572) | ((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_4) & ~(((1'b1 == ap_reg_ppiten_pp0_it1) & (ap_sig_582 | ((1'b0 == exitcond6_i_reg_587) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in)))) | ((1'b1 == ap_reg_ppiten_pp0_it2) & (1'b0 == ap_reg_ppstg_exitcond6_i_reg_587_pp0_iter1) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in))) & ~(1'b0 == exitcond6_i_fu_405_p2)))) begin
            ap_reg_ppiten_pp0_it1 <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (~(((1'b1 == ap_reg_ppiten_pp0_it1) & (ap_sig_582 | ((1'b0 == exitcond6_i_reg_587) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in)))) | ((1'b1 == ap_reg_ppiten_pp0_it2) & (1'b0 == ap_reg_ppstg_exitcond6_i_reg_587_pp0_iter1) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in)))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_4) & (1'b1 == ap_reg_ppiten_pp0_it0) & ~(((1'b1 == ap_reg_ppiten_pp0_it1) & (ap_sig_582 | ((1'b0 == exitcond6_i_reg_587) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in)))) | ((1'b1 == ap_reg_ppiten_pp0_it2) & (1'b0 == ap_reg_ppstg_exitcond6_i_reg_587_pp0_iter1) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in))) & ~(1'b0 == exitcond6_i_fu_405_p2))) begin
        i1_i_reg_227 <= i_1_reg_582;
    end else if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~(1'b0 == exitcond4_i_fu_279_p2))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_st4_fsm_3) & (1'b0 == exitcond5_i_fu_390_p2) & ~ap_sig_572)) begin
        j_i_reg_238 <= ap_const_lv11_0;
    end else if (((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_4) & (1'b1 == ap_reg_ppiten_pp0_it0) & ~(((1'b1 == ap_reg_ppiten_pp0_it1) & (ap_sig_582 | ((1'b0 == exitcond6_i_reg_587) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in)))) | ((1'b1 == ap_reg_ppiten_pp0_it2) & (1'b0 == ap_reg_ppstg_exitcond6_i_reg_587_pp0_iter1) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in))) & (1'b0 == exitcond6_i_fu_405_p2))) begin
        j_i_reg_238 <= j_fu_410_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_4) & (1'b1 == ap_reg_ppiten_pp0_it1) & (1'b0 == exitcond6_i_reg_587) & ~(((1'b1 == ap_reg_ppiten_pp0_it1) & (ap_sig_582 | ((1'b0 == exitcond6_i_reg_587) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in)))) | ((1'b1 == ap_reg_ppiten_pp0_it2) & (1'b0 == ap_reg_ppstg_exitcond6_i_reg_587_pp0_iter1) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in))))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_4) & ~(((1'b1 == ap_reg_ppiten_pp0_it1) & (ap_sig_582 | ((1'b0 == exitcond6_i_reg_587) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in)))) | ((1'b1 == ap_reg_ppiten_pp0_it2) & (1'b0 == ap_reg_ppstg_exitcond6_i_reg_587_pp0_iter1) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in))))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~(1'b0 == exitcond4_i_fu_279_p2))) begin
...
always @ (*) begin
    if ((((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_4) & (1'b1 == ap_reg_ppiten_pp0_it1) & (1'b0 == exitcond6_i_reg_587)) | ((1'b1 == ap_reg_ppiten_pp0_it2) & (1'b0 == ap_reg_ppstg_exitcond6_i_reg_587_pp0_iter1)))) begin
...
always @ (*) begin
    if (((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_4) & (1'b1 == ap_reg_ppiten_pp0_it1) & (1'b0 == exitcond6_i_reg_587))) begin
...
always @ (*) begin
    if (((1'b1 == ap_done_reg) | ((1'b1 == ap_sig_cseq_ST_st4_fsm_3) & ~(1'b0 == exitcond5_i_fu_390_p2) & ~ap_sig_572))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_st2_fsm_1 : begin
            if (~(1'b0 == exitcond4_i_fu_279_p2)) begin
        ...
        ap_ST_st4_fsm_3 : begin
            if ((~(1'b0 == exitcond5_i_fu_390_p2) & ~ap_sig_572)) begin
                ap_NS_fsm = ap_ST_st1_fsm_0;
            end else if (((1'b0 == exitcond5_i_fu_390_p2) & ~ap_sig_572)) begin
        ...
        ap_ST_pp0_stg0_fsm_4 : begin
            if ((~((1'b1 == ap_reg_ppiten_pp0_it2) & ~(((1'b1 == ap_reg_ppiten_pp0_it1) & (ap_sig_582 | ((1'b0 == exitcond6_i_reg_587) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in)))) | ((1'b1 == ap_reg_ppiten_pp0_it2) & (1'b0 == ap_reg_ppstg_exitcond6_i_reg_587_pp0_iter1) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in))) & ~(1'b1 == ap_reg_ppiten_pp0_it1)) & ~((1'b1 == ap_reg_ppiten_pp0_it0) & ~(((1'b1 == ap_reg_ppiten_pp0_it1) & (ap_sig_582 | ((1'b0 == exitcond6_i_reg_587) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in)))) | ((1'b1 == ap_reg_ppiten_pp0_it2) & (1'b0 == ap_reg_ppstg_exitcond6_i_reg_587_pp0_iter1) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in))) & ~(1'b0 == exitcond6_i_fu_405_p2) & ~(1'b1 == ap_reg_ppiten_pp0_it1)))) begin
                ap_NS_fsm = ap_ST_pp0_stg0_fsm_4;
            end else if ((((1'b1 == ap_reg_ppiten_pp0_it2) & ~(((1'b1 == ap_reg_ppiten_pp0_it1) & (ap_sig_582 | ((1'b0 == exitcond6_i_reg_587) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in)))) | ((1'b1 == ap_reg_ppiten_pp0_it2) & (1'b0 == ap_reg_ppstg_exitcond6_i_reg_587_pp0_iter1) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in))) & ~(1'b1 == ap_reg_ppiten_pp0_it1)) | ((1'b1 == ap_reg_ppiten_pp0_it0) & ~(((1'b1 == ap_reg_ppiten_pp0_it1) & (ap_sig_582 | ((1'b0 == exitcond6_i_reg_587) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in)))) | ((1'b1 == ap_reg_ppiten_pp0_it2) & (1'b0 == ap_reg_ppstg_exitcond6_i_reg_587_pp0_iter1) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in))) & ~(1'b0 == exitcond6_i_fu_405_p2) & ~(1'b1 == ap_reg_ppiten_pp0_it1)))) begin
                ap_NS_fsm = ap_ST_st4_fsm_3;
            end else begin
                ap_NS_fsm = ap_ST_pp0_stg0_fsm_4;
            end
...
always @ (*) begin
    ap_sig_582 = ((1'b0 == exitcond6_i_reg_587) & (StrmMPix_V_val_V_empty_n == 1'b0));
end

assign axi_last_V_fu_416_p2 = ((j_i_reg_238 == tmp_21_i_reg_543) ? 1'b1 : 1'b0);

assign exitcond4_i_fu_279_p2 = ((i_i_reg_215 == ap_const_lv2_3) ? 1'b1 : 1'b0);

assign exitcond5_i_fu_390_p2 = ((i1_cast_i_fu_386_p1 == tmp_26_reg_538) ? 1'b1 : 1'b0);

assign exitcond6_i_fu_405_p2 = ((j_cast_i_fu_401_p1 == tmp_23_reg_508) ? 1'b1 : 1'b0);

assign i1_cast_i_fu_386_p1 = i1_i_reg_227;

assign i_1_fu_395_p2 = (i1_i_reg_227 + ap_const_lv11_1);

assign i_fu_285_p2 = (i_i_reg_215 + ap_const_lv2_1);

assign j_cast_i_fu_401_p1 = j_i_reg_238;

assign j_fu_410_p2 = (j_i_reg_238 + ap_const_lv11_1);
...
assign p_shl_cast_fu_265_p3 = {{tmp_25_fu_261_p1}, {ap_const_lv2_0}};
...
assign tmp_1_fu_471_p2 = {{StrmMPix_V_val_V_dout[ap_const_lv6_F : ap_const_lv6_8]}};

assign tmp_1_fu_471_p3 = {{StrmMPix_V_val_V_dout[ap_const_lv6_17 : ap_const_lv6_10]}};

assign tmp_21_i_fu_308_p2 = ($signed(ap_const_lv11_7FF) + $signed(tmp_22_reg_503));

assign tmp_22_fu_249_p1 = WidthOut_dout[10:0];

assign tmp_22_i_cast_fu_291_p1 = i_i_reg_215;

assign tmp_23_fu_253_p1 = WidthOut_dout[11:0];

assign tmp_24_fu_257_p1 = ColorMode_dout[4:0];

assign tmp_25_fu_261_p1 = ColorMode_dout[2:0];

assign tmp_26_fu_305_p1 = Height_read_reg_498[11:0];

assign tmp_27_fu_313_p1 = map_2_V_4_reg_203[1:0];

assign tmp_28_fu_317_p1 = map_V_1_i_reg_191[1:0];

assign tmp_29_fu_321_p1 = map_V_2_i_reg_179[1:0];

assign tmp_8_fu_273_p2 = (p_shl_cast_fu_265_p3 - tmp_24_fu_257_p1);

assign tmp_9_cast_fu_300_p1 = $signed(tmp_9_fu_295_p2);

assign tmp_9_fu_295_p2 = (tmp_8_reg_513 + tmp_22_i_cast_fu_291_p1);

assign tmp_data_V_fu_482_p4 = {{{tmp_1_fu_471_p5}, {tmp_s_fu_460_p5}}, {tmp_fu_449_p5}};
