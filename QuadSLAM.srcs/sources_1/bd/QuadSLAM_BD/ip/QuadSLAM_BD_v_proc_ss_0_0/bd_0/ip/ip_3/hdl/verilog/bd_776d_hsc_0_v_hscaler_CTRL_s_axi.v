...
localparam
    ...
    ADDR_IER                    = 14'h0008,
    ADDR_ISR                    = 14'h000c,
    ADDR_HWREG_HEIGHT_DATA_0    = 14'h0010,
    ADDR_HWREG_HEIGHT_CTRL      = 14'h0014,
    ADDR_HWREG_WIDTHIN_DATA_0   = 14'h0018,
    ADDR_HWREG_WIDTHIN_CTRL     = 14'h001c,
    ADDR_HWREG_WIDTHOUT_DATA_0  = 14'h0020,
    ADDR_HWREG_WIDTHOUT_CTRL    = 14'h0024,
    ADDR_HWREG_COLORMODE_DATA_0 = 14'h0028,
    ADDR_HWREG_COLORMODE_CTRL   = 14'h002c,
    ADDR_HWREG_PIXELRATE_DATA_0 = 14'h0030,
    ADDR_HWREG_PIXELRATE_CTRL   = 14'h0034,
    ADDR_HWREG_PHASESH_V_BASE   = 14'h2000,
    ADDR_HWREG_PHASESH_V_HIGH   = 14'h3fff,
    WRIDLE                      = 2'd0,
    WRDATA                      = 2'd1,
    WRRESP                      = 2'd2,
    RDIDLE                      = 2'd0,
...
assign RVALID  = (rstate == RDDATA) & !int_HwReg_phasesH_V_read;
