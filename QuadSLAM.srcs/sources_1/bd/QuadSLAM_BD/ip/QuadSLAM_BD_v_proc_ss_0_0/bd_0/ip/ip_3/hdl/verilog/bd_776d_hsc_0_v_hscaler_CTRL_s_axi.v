...
`timescale 1ns/1ps
module bd_776d_hsc_0_v_hscaler_CTRL_s_axi
#(parameter
    ...
    input  wire [10:0]                   HwReg_phasesH_V_address0,
...
localparam
    ...
    ADDR_IER                    = 13'h0008,
    ADDR_ISR                    = 13'h000c,
    ADDR_HWREG_HEIGHT_DATA_0    = 13'h0010,
    ADDR_HWREG_HEIGHT_CTRL      = 13'h0014,
    ADDR_HWREG_WIDTHIN_DATA_0   = 13'h0018,
    ADDR_HWREG_WIDTHIN_CTRL     = 13'h001c,
    ADDR_HWREG_WIDTHOUT_DATA_0  = 13'h0020,
    ADDR_HWREG_WIDTHOUT_CTRL    = 13'h0024,
    ADDR_HWREG_COLORMODE_DATA_0 = 13'h0028,
    ADDR_HWREG_COLORMODE_CTRL   = 13'h002c,
    ADDR_HWREG_PIXELRATE_DATA_0 = 13'h0030,
    ADDR_HWREG_PIXELRATE_CTRL   = 13'h0034,
    ADDR_HWREG_HFLTCOEFF_BASE   = 13'h0800,
    ADDR_HWREG_HFLTCOEFF_HIGH   = 13'h0bff,
    ADDR_HWREG_PHASESH_V_BASE   = 13'h1000,
    ADDR_HWREG_PHASESH_V_HIGH   = 13'h1fff,
    WRIDLE                      = 2'd0,
    WRDATA                      = 2'd1,
    WRRESP                      = 2'd2,
    RDIDLE                      = 2'd0,
...
//------------------------Local signal-------------------
    ...
    reg  [1:0]                    int_ier;
    reg  [1:0]                    int_isr;
    reg  [15:0]                   int_HwReg_Height;
    reg  [15:0]                   int_HwReg_WidthIn;
    reg  [15:0]                   int_HwReg_WidthOut;
    reg  [7:0]                    int_HwReg_ColorMode;
    reg  [31:0]                   int_HwReg_PixelRate;
    // memory signals
    ...
    wire [9:0]                    int_HwReg_phasesH_V_address0;
    ...
    wire [9:0]                    int_HwReg_phasesH_V_address1;
...
//------------------------Instantiation------------------
// int_HwReg_hfltCoeff
bd_776d_hsc_0_v_hscaler_CTRL_s_axi_ram #(
    .BYTES    ( 4 ),
    .DEPTH    ( 192 )
) int_HwReg_hfltCoeff (
    .clk0     ( ACLK ),
...
assign int_HwReg_phasesH_V_address1 = ar_hs? raddr[11:2] : waddr[11:2];
...
module bd_776d_hsc_0_v_hscaler_CTRL_s_axi_ram
#(parameter
    BYTES  = 4,
    DEPTH  = 256,
    AWIDTH = log2(DEPTH)
