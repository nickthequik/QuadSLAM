...
architecture behav of bd_776d_hsc_0_v_hscaler_MultiPixStream2AXIvideo is 
    ...
    signal exitcond9_i_reg_587 : STD_LOGIC_VECTOR (0 downto 0);
    signal AXI_video_strm_TDATA_blk_n : STD_LOGIC;
    signal ap_reg_ppstg_exitcond9_i_reg_587_pp0_iter1 : STD_LOGIC_VECTOR (0 downto 0);
    signal Height_blk_n : STD_LOGIC;
    signal WidthOut_blk_n : STD_LOGIC;
    signal ColorMode_blk_n : STD_LOGIC;
    signal j_i_reg_238 : STD_LOGIC_VECTOR (11 downto 0);
    signal Height_read_reg_498 : STD_LOGIC_VECTOR (15 downto 0);
    signal ap_sig_502 : BOOLEAN;
    signal tmp_34_fu_249_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_34_reg_503 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_35_fu_253_p1 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_35_reg_508 : STD_LOGIC_VECTOR (12 downto 0);
    ...
    signal exitcond7_i_fu_279_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_38_fu_305_p1 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_38_reg_538 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_27_i_fu_308_p2 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_27_i_reg_543 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_39_fu_313_p1 : STD_LOGIC_VECTOR (1 downto 0);
    signal tmp_39_reg_548 : STD_LOGIC_VECTOR (1 downto 0);
    signal tmp_40_fu_317_p1 : STD_LOGIC_VECTOR (1 downto 0);
    signal tmp_40_reg_553 : STD_LOGIC_VECTOR (1 downto 0);
    signal tmp_41_fu_321_p1 : STD_LOGIC_VECTOR (1 downto 0);
    signal tmp_41_reg_558 : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal exitcond8_i_fu_390_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_sig_cseq_ST_st4_fsm_3 : STD_LOGIC;
    signal ap_sig_557 : BOOLEAN;
    signal ap_sig_572 : BOOLEAN;
    signal i_1_fu_395_p2 : STD_LOGIC_VECTOR (11 downto 0);
    signal i_1_reg_582 : STD_LOGIC_VECTOR (11 downto 0);
    signal exitcond9_i_fu_405_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_sig_582 : BOOLEAN;
    signal j_fu_410_p2 : STD_LOGIC_VECTOR (11 downto 0);
    ...
    signal i1_i_reg_227 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_9_cast_fu_300_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_user_V_fu_110 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_37_fu_261_p1 : STD_LOGIC_VECTOR (2 downto 0);
    signal p_shl_cast_fu_265_p3 : STD_LOGIC_VECTOR (4 downto 0);
    signal tmp_36_fu_257_p1 : STD_LOGIC_VECTOR (4 downto 0);
    signal tmp_28_i_cast_fu_291_p1 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal i1_cast_i_fu_386_p1 : STD_LOGIC_VECTOR (12 downto 0);
    signal j_cast_i_fu_401_p1 : STD_LOGIC_VECTOR (12 downto 0);
    ...
    signal tmp_12_fu_471_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_12_fu_471_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_12_fu_471_p5 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    v_hscaler_mux_3to1_sel2_8_1_U40 : component bd_776d_hsc_0_v_hscaler_mux_3to1_sel2_8_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din1_WIDTH => 8,
    ...
    v_hscaler_mux_3to1_sel2_8_1_U41 : component bd_776d_hsc_0_v_hscaler_mux_3to1_sel2_8_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din1_WIDTH => 8,
    ...
    v_hscaler_mux_3to1_sel2_8_1_U42 : component bd_776d_hsc_0_v_hscaler_mux_3to1_sel2_8_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din1_WIDTH => 8,
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_const_logic_1 = ap_continue)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((ap_const_logic_1 = ap_sig_cseq_ST_st4_fsm_3) and not((ap_const_lv1_0 = exitcond8_i_fu_390_p2)) and not(ap_sig_572))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_4) and not((((ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (ap_sig_582 or ((ap_const_lv1_0 = exitcond9_i_reg_587) and (ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in)))) or ((ap_const_logic_1 = ap_reg_ppiten_pp0_it2) and (ap_const_lv1_0 = ap_reg_ppstg_exitcond9_i_reg_587_pp0_iter1) and (ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in)))) and not((ap_const_lv1_0 = exitcond9_i_fu_405_p2)))) then 
                    ap_reg_ppiten_pp0_it0 <= ap_const_logic_0;
                elsif (((ap_const_logic_1 = ap_sig_cseq_ST_st4_fsm_3) and (ap_const_lv1_0 = exitcond8_i_fu_390_p2) and not(ap_sig_572))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_4) and not((((ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (ap_sig_582 or ((ap_const_lv1_0 = exitcond9_i_reg_587) and (ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in)))) or ((ap_const_logic_1 = ap_reg_ppiten_pp0_it2) and (ap_const_lv1_0 = ap_reg_ppstg_exitcond9_i_reg_587_pp0_iter1) and (ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in)))) and (ap_const_lv1_0 = exitcond9_i_fu_405_p2))) then 
                    ap_reg_ppiten_pp0_it1 <= ap_const_logic_1;
                elsif ((((ap_const_logic_1 = ap_sig_cseq_ST_st4_fsm_3) and (ap_const_lv1_0 = exitcond8_i_fu_390_p2) and not(ap_sig_572)) or ((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_4) and not((((ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (ap_sig_582 or ((ap_const_lv1_0 = exitcond9_i_reg_587) and (ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in)))) or ((ap_const_logic_1 = ap_reg_ppiten_pp0_it2) and (ap_const_lv1_0 = ap_reg_ppstg_exitcond9_i_reg_587_pp0_iter1) and (ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in)))) and not((ap_const_lv1_0 = exitcond9_i_fu_405_p2))))) then 
                    ap_reg_ppiten_pp0_it1 <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (not((((ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (ap_sig_582 or ((ap_const_lv1_0 = exitcond9_i_reg_587) and (ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in)))) or ((ap_const_logic_1 = ap_reg_ppiten_pp0_it2) and (ap_const_lv1_0 = ap_reg_ppstg_exitcond9_i_reg_587_pp0_iter1) and (ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in))))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_4) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it0) and not((((ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (ap_sig_582 or ((ap_const_lv1_0 = exitcond9_i_reg_587) and (ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in)))) or ((ap_const_logic_1 = ap_reg_ppiten_pp0_it2) and (ap_const_lv1_0 = ap_reg_ppstg_exitcond9_i_reg_587_pp0_iter1) and (ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in)))) and not((ap_const_lv1_0 = exitcond9_i_fu_405_p2)))) then 
                i1_i_reg_227 <= i_1_reg_582;
            elsif (((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1) and not((ap_const_lv1_0 = exitcond7_i_fu_279_p2)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_st4_fsm_3) and (ap_const_lv1_0 = exitcond8_i_fu_390_p2) and not(ap_sig_572))) then 
                j_i_reg_238 <= ap_const_lv12_0;
            elsif (((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_4) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it0) and not((((ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (ap_sig_582 or ((ap_const_lv1_0 = exitcond9_i_reg_587) and (ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in)))) or ((ap_const_logic_1 = ap_reg_ppiten_pp0_it2) and (ap_const_lv1_0 = ap_reg_ppstg_exitcond9_i_reg_587_pp0_iter1) and (ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in)))) and (ap_const_lv1_0 = exitcond9_i_fu_405_p2))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_4) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (ap_const_lv1_0 = exitcond9_i_reg_587) and not((((ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (ap_sig_582 or ((ap_const_lv1_0 = exitcond9_i_reg_587) and (ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in)))) or ((ap_const_logic_1 = ap_reg_ppiten_pp0_it2) and (ap_const_lv1_0 = ap_reg_ppstg_exitcond9_i_reg_587_pp0_iter1) and (ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in)))))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_4) and not((((ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (ap_sig_582 or ((ap_const_lv1_0 = exitcond9_i_reg_587) and (ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in)))) or ((ap_const_logic_1 = ap_reg_ppiten_pp0_it2) and (ap_const_lv1_0 = ap_reg_ppstg_exitcond9_i_reg_587_pp0_iter1) and (ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in)))))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1) and not((ap_const_lv1_0 = exitcond7_i_fu_279_p2)))) then
    ...
    ap_NS_fsm_assign_proc : process (ap_CS_fsm, AXI_video_strm_V_data_V_1_ack_in, ap_reg_ppiten_pp0_it1, ap_reg_ppiten_pp0_it0, ap_reg_ppiten_pp0_it2, exitcond9_i_reg_587, ap_reg_ppstg_exitcond9_i_reg_587_pp0_iter1, ap_sig_502, exitcond7_i_fu_279_p2, exitcond8_i_fu_390_p2, ap_sig_572, exitcond9_i_fu_405_p2, ap_sig_582)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_st2_fsm_1 => 
                if (not((ap_const_lv1_0 = exitcond7_i_fu_279_p2))) then
            ...
            when ap_ST_st4_fsm_3 => 
                if ((not((ap_const_lv1_0 = exitcond8_i_fu_390_p2)) and not(ap_sig_572))) then
                    ap_NS_fsm <= ap_ST_st1_fsm_0;
                elsif (((ap_const_lv1_0 = exitcond8_i_fu_390_p2) and not(ap_sig_572))) then
                    ap_NS_fsm <= ap_ST_pp0_stg0_fsm_4;
                else
                    ap_NS_fsm <= ap_ST_st4_fsm_3;
                end if;
            when ap_ST_pp0_stg0_fsm_4 => 
                if ((not(((ap_const_logic_1 = ap_reg_ppiten_pp0_it2) and not((((ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (ap_sig_582 or ((ap_const_lv1_0 = exitcond9_i_reg_587) and (ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in)))) or ((ap_const_logic_1 = ap_reg_ppiten_pp0_it2) and (ap_const_lv1_0 = ap_reg_ppstg_exitcond9_i_reg_587_pp0_iter1) and (ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in)))) and not((ap_const_logic_1 = ap_reg_ppiten_pp0_it1)))) and not(((ap_const_logic_1 = ap_reg_ppiten_pp0_it0) and not((((ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (ap_sig_582 or ((ap_const_lv1_0 = exitcond9_i_reg_587) and (ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in)))) or ((ap_const_logic_1 = ap_reg_ppiten_pp0_it2) and (ap_const_lv1_0 = ap_reg_ppstg_exitcond9_i_reg_587_pp0_iter1) and (ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in)))) and not((ap_const_lv1_0 = exitcond9_i_fu_405_p2)) and not((ap_const_logic_1 = ap_reg_ppiten_pp0_it1)))))) then
                    ap_NS_fsm <= ap_ST_pp0_stg0_fsm_4;
                elsif ((((ap_const_logic_1 = ap_reg_ppiten_pp0_it2) and not((((ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (ap_sig_582 or ((ap_const_lv1_0 = exitcond9_i_reg_587) and (ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in)))) or ((ap_const_logic_1 = ap_reg_ppiten_pp0_it2) and (ap_const_lv1_0 = ap_reg_ppstg_exitcond9_i_reg_587_pp0_iter1) and (ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in)))) and not((ap_const_logic_1 = ap_reg_ppiten_pp0_it1))) or ((ap_const_logic_1 = ap_reg_ppiten_pp0_it0) and not((((ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (ap_sig_582 or ((ap_const_lv1_0 = exitcond9_i_reg_587) and (ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in)))) or ((ap_const_logic_1 = ap_reg_ppiten_pp0_it2) and (ap_const_lv1_0 = ap_reg_ppstg_exitcond9_i_reg_587_pp0_iter1) and (ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in)))) and not((ap_const_lv1_0 = exitcond9_i_fu_405_p2)) and not((ap_const_logic_1 = ap_reg_ppiten_pp0_it1))))) then
                    ap_NS_fsm <= ap_ST_st4_fsm_3;
                else
                    ap_NS_fsm <= ap_ST_pp0_stg0_fsm_4;
                end if;
    ...
    AXI_video_strm_TDATA_blk_n_assign_proc : process(AXI_video_strm_V_data_V_1_state, ap_sig_cseq_ST_pp0_stg0_fsm_4, ap_reg_ppiten_pp0_it1, ap_reg_ppiten_pp0_it2, exitcond9_i_reg_587, ap_reg_ppstg_exitcond9_i_reg_587_pp0_iter1)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_4) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (ap_const_lv1_0 = exitcond9_i_reg_587)) or ((ap_const_logic_1 = ap_reg_ppiten_pp0_it2) and (ap_const_lv1_0 = ap_reg_ppstg_exitcond9_i_reg_587_pp0_iter1)))) then 
    ...
    AXI_video_strm_V_data_V_1_vld_in_assign_proc : process(AXI_video_strm_V_data_V_1_ack_in, ap_sig_cseq_ST_pp0_stg0_fsm_4, ap_reg_ppiten_pp0_it1, ap_reg_ppiten_pp0_it2, exitcond9_i_reg_587, ap_reg_ppstg_exitcond9_i_reg_587_pp0_iter1, ap_sig_582)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_4) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (ap_const_lv1_0 = exitcond9_i_reg_587) and not((((ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (ap_sig_582 or ((ap_const_lv1_0 = exitcond9_i_reg_587) and (ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in)))) or ((ap_const_logic_1 = ap_reg_ppiten_pp0_it2) and (ap_const_lv1_0 = ap_reg_ppstg_exitcond9_i_reg_587_pp0_iter1) and (ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in)))))) then 
    ...
    AXI_video_strm_V_dest_V_1_vld_in_assign_proc : process(AXI_video_strm_V_data_V_1_ack_in, ap_sig_cseq_ST_pp0_stg0_fsm_4, ap_reg_ppiten_pp0_it1, ap_reg_ppiten_pp0_it2, exitcond9_i_reg_587, ap_reg_ppstg_exitcond9_i_reg_587_pp0_iter1, ap_sig_582)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_4) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (ap_const_lv1_0 = exitcond9_i_reg_587) and not((((ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (ap_sig_582 or ((ap_const_lv1_0 = exitcond9_i_reg_587) and (ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in)))) or ((ap_const_logic_1 = ap_reg_ppiten_pp0_it2) and (ap_const_lv1_0 = ap_reg_ppstg_exitcond9_i_reg_587_pp0_iter1) and (ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in)))))) then 
    ...
    AXI_video_strm_V_id_V_1_vld_in_assign_proc : process(AXI_video_strm_V_data_V_1_ack_in, ap_sig_cseq_ST_pp0_stg0_fsm_4, ap_reg_ppiten_pp0_it1, ap_reg_ppiten_pp0_it2, exitcond9_i_reg_587, ap_reg_ppstg_exitcond9_i_reg_587_pp0_iter1, ap_sig_582)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_4) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (ap_const_lv1_0 = exitcond9_i_reg_587) and not((((ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (ap_sig_582 or ((ap_const_lv1_0 = exitcond9_i_reg_587) and (ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in)))) or ((ap_const_logic_1 = ap_reg_ppiten_pp0_it2) and (ap_const_lv1_0 = ap_reg_ppstg_exitcond9_i_reg_587_pp0_iter1) and (ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in)))))) then 
    ...
    AXI_video_strm_V_keep_V_1_vld_in_assign_proc : process(AXI_video_strm_V_data_V_1_ack_in, ap_sig_cseq_ST_pp0_stg0_fsm_4, ap_reg_ppiten_pp0_it1, ap_reg_ppiten_pp0_it2, exitcond9_i_reg_587, ap_reg_ppstg_exitcond9_i_reg_587_pp0_iter1, ap_sig_582)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_4) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (ap_const_lv1_0 = exitcond9_i_reg_587) and not((((ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (ap_sig_582 or ((ap_const_lv1_0 = exitcond9_i_reg_587) and (ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in)))) or ((ap_const_logic_1 = ap_reg_ppiten_pp0_it2) and (ap_const_lv1_0 = ap_reg_ppstg_exitcond9_i_reg_587_pp0_iter1) and (ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in)))))) then 
    ...
    AXI_video_strm_V_last_V_1_vld_in_assign_proc : process(AXI_video_strm_V_data_V_1_ack_in, ap_sig_cseq_ST_pp0_stg0_fsm_4, ap_reg_ppiten_pp0_it1, ap_reg_ppiten_pp0_it2, exitcond9_i_reg_587, ap_reg_ppstg_exitcond9_i_reg_587_pp0_iter1, ap_sig_582)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_4) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (ap_const_lv1_0 = exitcond9_i_reg_587) and not((((ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (ap_sig_582 or ((ap_const_lv1_0 = exitcond9_i_reg_587) and (ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in)))) or ((ap_const_logic_1 = ap_reg_ppiten_pp0_it2) and (ap_const_lv1_0 = ap_reg_ppstg_exitcond9_i_reg_587_pp0_iter1) and (ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in)))))) then 
    ...
    AXI_video_strm_V_strb_V_1_vld_in_assign_proc : process(AXI_video_strm_V_data_V_1_ack_in, ap_sig_cseq_ST_pp0_stg0_fsm_4, ap_reg_ppiten_pp0_it1, ap_reg_ppiten_pp0_it2, exitcond9_i_reg_587, ap_reg_ppstg_exitcond9_i_reg_587_pp0_iter1, ap_sig_582)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_4) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (ap_const_lv1_0 = exitcond9_i_reg_587) and not((((ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (ap_sig_582 or ((ap_const_lv1_0 = exitcond9_i_reg_587) and (ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in)))) or ((ap_const_logic_1 = ap_reg_ppiten_pp0_it2) and (ap_const_lv1_0 = ap_reg_ppstg_exitcond9_i_reg_587_pp0_iter1) and (ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in)))))) then 
    ...
    AXI_video_strm_V_user_V_1_vld_in_assign_proc : process(AXI_video_strm_V_data_V_1_ack_in, ap_sig_cseq_ST_pp0_stg0_fsm_4, ap_reg_ppiten_pp0_it1, ap_reg_ppiten_pp0_it2, exitcond9_i_reg_587, ap_reg_ppstg_exitcond9_i_reg_587_pp0_iter1, ap_sig_582)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_4) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (ap_const_lv1_0 = exitcond9_i_reg_587) and not((((ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (ap_sig_582 or ((ap_const_lv1_0 = exitcond9_i_reg_587) and (ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in)))) or ((ap_const_logic_1 = ap_reg_ppiten_pp0_it2) and (ap_const_lv1_0 = ap_reg_ppstg_exitcond9_i_reg_587_pp0_iter1) and (ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in)))))) then 
    ...
    StrmMPix_V_val_V_blk_n_assign_proc : process(StrmMPix_V_val_V_empty_n, ap_sig_cseq_ST_pp0_stg0_fsm_4, ap_reg_ppiten_pp0_it1, exitcond9_i_reg_587)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_4) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (ap_const_lv1_0 = exitcond9_i_reg_587))) then 
    ...
    StrmMPix_V_val_V_read_assign_proc : process(AXI_video_strm_V_data_V_1_ack_in, ap_sig_cseq_ST_pp0_stg0_fsm_4, ap_reg_ppiten_pp0_it1, ap_reg_ppiten_pp0_it2, exitcond9_i_reg_587, ap_reg_ppstg_exitcond9_i_reg_587_pp0_iter1, ap_sig_582)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_4) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (ap_const_lv1_0 = exitcond9_i_reg_587) and not((((ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (ap_sig_582 or ((ap_const_lv1_0 = exitcond9_i_reg_587) and (ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in)))) or ((ap_const_logic_1 = ap_reg_ppiten_pp0_it2) and (ap_const_lv1_0 = ap_reg_ppstg_exitcond9_i_reg_587_pp0_iter1) and (ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in)))))) then 
    ...
    ap_done_assign_proc : process(ap_done_reg, exitcond8_i_fu_390_p2, ap_sig_cseq_ST_st4_fsm_3, ap_sig_572)
    begin
        if (((ap_const_logic_1 = ap_done_reg) or ((ap_const_logic_1 = ap_sig_cseq_ST_st4_fsm_3) and not((ap_const_lv1_0 = exitcond8_i_fu_390_p2)) and not(ap_sig_572)))) then 
    ...
    ap_ready_assign_proc : process(exitcond8_i_fu_390_p2, ap_sig_cseq_ST_st4_fsm_3, ap_sig_572)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_st4_fsm_3) and not((ap_const_lv1_0 = exitcond8_i_fu_390_p2)) and not(ap_sig_572))) then 
    ...
    ap_sig_582_assign_proc : process(StrmMPix_V_val_V_empty_n, exitcond9_i_reg_587)
    begin
                ap_sig_582 <= ((ap_const_lv1_0 = exitcond9_i_reg_587) and (StrmMPix_V_val_V_empty_n = ap_const_logic_0));
    end process;
    ...
    axi_last_V_fu_416_p2 <= "1" when (j_i_reg_238 = tmp_27_i_reg_543) else "0";
    exitcond7_i_fu_279_p2 <= "1" when (i_i_reg_215 = ap_const_lv2_3) else "0";
    exitcond8_i_fu_390_p2 <= "1" when (i1_cast_i_fu_386_p1 = tmp_38_reg_538) else "0";
    exitcond9_i_fu_405_p2 <= "1" when (j_cast_i_fu_401_p1 = tmp_35_reg_508) else "0";
    i1_cast_i_fu_386_p1 <= std_logic_vector(resize(unsigned(i1_i_reg_227),13));
    i_1_fu_395_p2 <= std_logic_vector(unsigned(i1_i_reg_227) + unsigned(ap_const_lv12_1));
    i_fu_285_p2 <= std_logic_vector(unsigned(i_i_reg_215) + unsigned(ap_const_lv2_1));
    j_cast_i_fu_401_p1 <= std_logic_vector(resize(unsigned(j_i_reg_238),13));
    j_fu_410_p2 <= std_logic_vector(unsigned(j_i_reg_238) + unsigned(ap_const_lv12_1));
    ...
    p_shl_cast_fu_265_p3 <= (tmp_37_fu_261_p1 & ap_const_lv2_0);
    ...
    tmp_12_fu_471_p2 <= StrmMPix_V_val_V_dout(15 downto 8);
    tmp_12_fu_471_p3 <= StrmMPix_V_val_V_dout(23 downto 16);
    tmp_27_i_fu_308_p2 <= std_logic_vector(signed(ap_const_lv12_FFF) + signed(tmp_34_reg_503));
    tmp_28_i_cast_fu_291_p1 <= std_logic_vector(resize(unsigned(i_i_reg_215),5));
    tmp_34_fu_249_p1 <= WidthOut_dout(12 - 1 downto 0);
    tmp_35_fu_253_p1 <= WidthOut_dout(13 - 1 downto 0);
    tmp_36_fu_257_p1 <= ColorMode_dout(5 - 1 downto 0);
    tmp_37_fu_261_p1 <= ColorMode_dout(3 - 1 downto 0);
    tmp_38_fu_305_p1 <= Height_read_reg_498(13 - 1 downto 0);
    tmp_39_fu_313_p1 <= map_2_V_4_reg_203(2 - 1 downto 0);
    tmp_40_fu_317_p1 <= map_V_1_i_reg_191(2 - 1 downto 0);
    tmp_41_fu_321_p1 <= map_V_2_i_reg_179(2 - 1 downto 0);
    tmp_8_fu_273_p2 <= std_logic_vector(unsigned(p_shl_cast_fu_265_p3) - unsigned(tmp_36_fu_257_p1));
        tmp_9_cast_fu_300_p1 <= std_logic_vector(resize(signed(tmp_9_fu_295_p2),64));

    tmp_9_fu_295_p2 <= std_logic_vector(unsigned(tmp_8_reg_513) + unsigned(tmp_28_i_cast_fu_291_p1));
    tmp_data_V_fu_482_p4 <= ((tmp_12_fu_471_p5 & tmp_s_fu_460_p5) & tmp_fu_449_p5);
