...
################################################################
# This is a generated script based on design: bd_776d
#
...
CONFIG.TUSER_WIDTH {1} \
  ...
  set_property -dict [ list \
CONFIG.ASSOCIATED_RESET {aresetn_io_axis} \
 ] $aclk_axis
...
CONFIG.DOUT_WIDTH {1} \
  ...
  connect_bd_intf_net -intf_net intf_net_axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins hsc/s_axi_CTRL]
  connect_bd_intf_net -intf_net intf_net_axi_interconnect_0_M01_AXI [get_bd_intf_pins axi_interconnect_0/M01_AXI] [get_bd_intf_pins vsc/s_axi_CTRL]
  connect_bd_intf_net -intf_net intf_net_axi_interconnect_0_M02_AXI [get_bd_intf_pins axi_interconnect_0/M02_AXI] [get_bd_intf_pins reset_sel_axis/S_AXI]
  ...
  connect_bd_net -net net_bdry_in_aclk_axis [get_bd_ports aclk_axis] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axis_fifo/s_axis_aclk] [get_bd_pins axis_register_slice_0/aclk] [get_bd_pins hsc/ap_clk] [get_bd_pins input_size_set/aclk] [get_bd_pins reset_sel_axis/s_axi_aclk] [get_bd_pins rst_axis/slowest_sync_clk] [get_bd_pins vsc/ap_clk]
  connect_bd_net -net net_bdry_in_aclk_ctrl [get_bd_ports aclk_ctrl] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK]
  connect_bd_net -net net_bdry_in_aresetn_ctrl [get_bd_ports aresetn_ctrl] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins rst_axis/ext_reset_in]
  ...
  connect_bd_net -net net_rst_axis_peripheral_aresetn [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins reset_sel_axis/s_axi_aresetn] [get_bd_pins rst_axis/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x00000000 [get_bd_addr_spaces s_axi_ctrl] [get_bd_addr_segs hsc/s_axi_CTRL/Reg] SEG_hsc_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x00010000 [get_bd_addr_spaces s_axi_ctrl] [get_bd_addr_segs reset_sel_axis/S_AXI/Reg] SEG_reset_sel_axis_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x00020000 [get_bd_addr_spaces s_axi_ctrl] [get_bd_addr_segs vsc/s_axi_CTRL/Reg] SEG_vsc_Reg
