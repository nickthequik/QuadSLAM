...
#
# Generated by export_simulation on Thu Nov 09 12:59:47 -0800 2017
#
################################################################################
...
switch to the './sobel_input_fifo.sh' script.

./sobel_input_fifo.sh -reset_run
...
./sobel_input_fifo.sh -noclean_files

For more information on the script, please type './sobel_input_fifo.sh -help'.
