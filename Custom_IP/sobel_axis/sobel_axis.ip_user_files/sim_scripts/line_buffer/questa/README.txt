...
#
# Generated by export_simulation on Thu Nov 09 12:59:49 -0800 2017
#
################################################################################
...
switch to the './line_buffer.sh' script.

./line_buffer.sh -reset_run
...
./line_buffer.sh -noclean_files

For more information on the script, please type './line_buffer.sh -help'.
