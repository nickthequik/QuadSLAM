...
HD_PWD='C:/Users/NicholasKimball/Documents/School/Senior/CPE439/QuadSLAM/Custom_IP/pwm_detector/pwm_detector.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_detector.vds -m64 -mode batch -messageDb vivado.pb -notrace -source pwm_detector.tcl
