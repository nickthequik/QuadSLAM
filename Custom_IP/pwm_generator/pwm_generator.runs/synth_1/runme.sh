...
HD_PWD='C:/Users/NicholasKimball/Documents/School/Senior/CPE439/QuadSLAM/Custom_IP/pwm_generator/pwm_generator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_generator.vds -m64 -mode batch -messageDb vivado.pb -notrace -source pwm_generator.tcl
